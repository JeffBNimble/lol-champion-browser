...
export async function getChampionData() {
  ...
  // champion square image URL's for each champion and add a new property so that
  // each champion now has the full URL to their square image. Notice that I pass
...
// deriving a square image URL and attaching a new property to the champion
// with the value of the derived URL.
function deriveSquareImageURLs(champions, baseURL, version) {
  ...
  // element is given the variable name champion and I calculate and set a new squareImageURL property on the champion
